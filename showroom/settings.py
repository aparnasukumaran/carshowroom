...
ALLOWED_HOSTS = [ '127.0.0.1',
    'localhost',
    'prestigelane.pythonanywhere.com',]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.brands_processor',
                'accounts.context_processors.admin_sidebar_counts',
                'accounts.context_processors.subscription_status',
